...
const Moviecr = ({movie}) => {
  ...
  return (
    ...
    rounded-2x1 hover:-translate-y-1 transition duration-300 rounded-lg w-66'>
      ...
      <div className='flex items-center justify-between mt-4 pb-3'>
        ...
        <p className='flex items-center gap-1 text-sm text-gray-400 mt- pr-1'>
