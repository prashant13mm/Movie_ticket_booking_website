...
const seatlayout = () => {
  ...
  // useparam se upar ke url se date aur id aa jati hai
  ...
  const handleSeatClick = (seatId) => {
    ...
    // ab iske baad waali line of code isliye to check and uncheck the box or selected seat
  ...
  return show ? (
    ...
    >
      ...
      <div className="relative flex-1 flex flex-col items-center max-md:mt-16">
        ...
        mt-20 px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition
        rounded-full font-medium cursor-pointer active:scale-95">Proceed to Checkout <ArrowRightIcon strokeWidth={3} className="w-4 h-4"/></button>
      </div>
    </div>
  ) : (
    <Loading />
